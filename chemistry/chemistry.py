...
Brother Keers
12:45
youtube link: https://youtu.be/q5aCry0MLug
"""
...
def main():
    ...
    userFormula = input("Enter a chemical formula: ")
    # Get the mass of a chemical sample in grams from the user.
    userMass = float(input("Enter the mass of the sample in grams: "))
    ...
    molar_mass = compute_molar_mass(parse_formula(userFormula, periodic_table_dict), periodic_table_dict)
    # Compute the number of moles in the sample.
    number_of_moles = userMass / molar_mass
    # Print the molar mass.
    print(f"The molar mass of {userFormula} is {molar_mass:.5f} g/mol.")
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    molar_mass = 0
    for symbol_quantity_list in symbol_quantity_list:
        symbol = symbol_quantity_list[SYMBOL_INDEX]
        quantity = symbol_quantity_list[QUANTITY_INDEX]
        # Get the atomic mass for the symbol from the dictionary.
        atomic_mass = periodic_table_dict[symbol][ATOMIC_MASS_INDEX]
        # Multiply the atomic mass by the quantity. Add the product into the total molar mass.
