...
def main():
    ...
    frm_main = Frame(root)
    frm_main.master.title("Circle Calculator")
...
def populate_main_window(frm_main):
    ...
    lbl_radius = Label(frm_main, text="Input Radius (0-1000): ")

    # Create an integer entry box where the user will enter her age.
    ent_radius = IntEntry(frm_main, width=4, lower_bound=0, upper_bound=1000)
    ...
    lbl_rate_units = Label(frm_main, text="Units Squared")
    ...
    lbl_area.grid(      row=1, column=2, padx=3, pady=3)
